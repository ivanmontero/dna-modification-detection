...
def plot_chromosome(chromosome, sequence_length=10, standardized=False):
    global TABLE
    ...
    name = chromosome + "_" + str(sequence_length) + "_pca"
    if standardized:
        name += "_standardized"
    plot_and_save(reduced, labels, name)
